...
class TestMetadata(unittest.TestCase):
    ...
    def test_png(self):
        ...
        self.check_attr(metadata, "creation_date", datetime(2006, 5, 26, 9, 41, 46))
    ...
    def test_gzip(self):
        ...
        self.check_attr(metadata, "last_modification", datetime(2006, 7, 29, 12, 20, 44))
    ...
    def test_mp3(self):
        ...
        self.check_attr(metadata, "comment", "Stainless Steel Provider is compilated to the car of Twinstar.")
    ...
    def test_mkv(self):
        ...
        self.check_attr(metadata, "copyright", "© dadaprod, licence Creative Commons by-nc-sa 2.0 fr")
        self.check_attr(metadata, "video[1]/width", 384)
        self.check_attr(metadata, "video[1]/language", Language('fre'))
        self.check_attr(metadata, "duration", timedelta(seconds=17, milliseconds=844))
    ...
    def test_au(self):
        ...
        self.check_attr(meta, "duration", timedelta(seconds=4, microseconds=391538))
    ...
    def test_tar(self):
        ...
        self.check_attr(meta, "file[1]/last_modification", datetime(2006, 10, 1, 13, 9, 3))
    ...
    def test_avi(self):
        ...
        self.check_attr(metadata, "duration", timedelta(minutes=44, seconds=1, microseconds=141141))
        self.check_attr(metadata, "producer", "VirtualDubMod 1.5.10.1 (build 2366/release)")
        self.check_attr(metadata, "video/width", 640)
        self.check_attr(metadata, "video/height", 352)
        self.check_attr(metadata, "video/compression", 'XviD MPEG-4 (fourcc:"xvid")')
    ...
    def test_mp3_2(self):
        ...
        self.check_attr(meta, "url", "Liens direct ARTE Radio: www.arteradio.com/son.html?473")
    ...
    def test_jpeg(self):
        ...
        self.check_attr(meta, "creation_date", datetime(2006, 6, 28, 14, 51, 9))
    ...
    def test_ogg_vorbis(self):
        ...
        self.check_attr(meta, "duration", timedelta(minutes=1, seconds=12, microseconds=19592))
    ...
    def test_flv(self):
        ...
        self.check_attr(meta, "duration", timedelta(seconds=46, milliseconds=942))
        self.check_attr(meta, "producer", ["YouTube, Inc.", "YouTube Metadata Injector."])

    def test_wmv(self):
        meta = self.extract("matrix_ping_pong.wmv")
        self.check_attr(meta, "title", "欽ちゃん＆香取慎吾の全日本仮装大賞")
        self.check_attr(meta, "duration", timedelta(minutes=1, seconds=47, milliseconds=258))
        self.check_attr(meta, "creation_date", datetime(2003, 6, 16, 7, 57, 23, 235000))
        self.check_attr(meta, "audio[1]/sample_rate", 8000)
        self.check_attr(meta, "audio[1]/bits_per_sample", 16)
        self.check_attr(meta, "audio[1]/compression", "Windows Media Audio V7 / V8 / V9")
    ...
    def test_wav_2(self):
        ...
        self.check_attr(meta, "duration", timedelta(hours=1, minutes=16, seconds=32, microseconds=516032))
    ...
    def test_sxw(self):
        ...
        self.check_attr(meta, "file[1]/creation_date", datetime(2007, 1, 22, 19, 8, 14))
        self.check_attr(meta, "file[2]/filename", "Configurations2/accelerator/current.xml")
        self.check_attr(meta, "file[2]/compression", "Deflate")

    def test_rm(self):
        meta = self.extract("firstrun.rm")
        self.check_attr(meta, "duration", timedelta(seconds=17, milliseconds=66))
        self.check_attr(meta, "creation_date", datetime(2000, 6, 14, 10, 3, 18))
        self.check_attr(meta, "copyright", "©2000 RealNetworks")
        self.check_attr(meta, "producer", "RealProducer Plus 6.1.0.153 Windows")
    ...
    def test_ttf(self):
        ...
        self.check_attr(meta, "creation_date", datetime(2006, 7, 6, 17, 29, 52))
        self.check_attr(meta, "last_modification", datetime(2006, 7, 6, 17, 29, 52))
    ...
    def test_exe_pe(self):
        ...
        self.check_attr(meta, "format_version", "New-style executable: Dynamic-link library (DLL)")

    def test_torrent(self):
        meta = self.extract("debian-31r4-i386-binary-1.iso.torrent")
        self.check_attr(meta, "filename", "debian-31r4-i386-binary-1.iso")
        self.check_attr(meta, "url", "http://bttracker.acc.umu.se:6969/announce")
        self.check_attr(meta, "file_size", 669775872)
        self.check_attr(meta, "creation_date", datetime(2006, 11, 16, 21, 44, 37))

    def test_jpeg_3(self):
        meta = self.extract("green_fire.jpg")
        self.check_attr(meta, 'height', 64)
        self.check_attr(meta, 'bits_per_pixel', 32)
        self.check_attr(meta, 'comment', ("Intel(R) JPEG Library, version 1,5,4,36", "JPEG quality: 80%"))

    def test_mp3_3(self):
        meta = self.extract("marc_kravetz.mp3")
        self.check_attr(meta, 'creation_date', datetime(2007, 7, 19, 9, 3, 57, tzinfo=createTimezone(2)))
        self.check_attr(meta, 'sample_rate', 48000)
        self.check_attr(meta, 'compr_rate', 12.0)
        self.check_attr(meta, 'album', "France Culture - Le portrait du jour par Marc Kravetz")
    ...
    def test_mov(self):
        ...
        self.check_attr(meta, 'creation_date', datetime(2005, 8, 11, 14, 3, 54))
        self.check_attr(meta, 'last_modification', datetime(2005, 8, 11, 14, 3, 54))

    def test_jpeg_gps(self):
        meta = self.extract("gps.jpg")
        self.check_attr(meta, 'altitude', 78.0)
        self.check_attr(meta, 'creation_date', datetime(2003, 5, 24, 22, 29, 14))
    ...
    def test_ani(self):
        ...
        self.check_attr(meta, 'artist', "Copyright ©Loraine Wauer-Ferus http://www.billybear4kids.com")
    ...
    def test_flac(self):
        ...
        self.check_attr(meta, 'duration', timedelta(seconds=51, microseconds=512834))
        self.check_attr(meta, 'nb_channel', 2)
        self.check_attr(meta, 'sample_rate', 44100)
        self.check_attr(meta, 'bits_per_sample', 16)
