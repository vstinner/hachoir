...
latex_documents = [
  ('index', 'Hachoir.tex', 'Hachoir Documentation',
...
man_pages = [
    ('index', 'hachoir', 'Hachoir Documentation',
     ['Victor Stinner'], 1)
]
...
texinfo_documents = [
  ('index', 'Hachoir', 'Hachoir Documentation',
   'Victor Stinner', 'Hachoir', 'One line description of project.',
   'Miscellaneous'),
]
